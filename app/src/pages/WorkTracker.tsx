    ...
    <div className="min-h-screen bg-gray-900 text-white p-6">
      <div className="max-w-4xl mx-auto">
        <header className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold">Work Time Tracker</h1>
          <button
            onClick={logout}
        ...
        <div>
          ...
          {workSessions.length === 0 ? (
            ...
            <div className="space-y-4">
              {workSessions
                .filter(session => session.clockOut) // Only show completed sessions
                .reverse() // Show newest first
                .map(session => (
                  <div key={session.clockIn.id} className="bg-gray-800 rounded-lg p-4 border border-gray-700">
